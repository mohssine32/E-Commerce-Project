...
const ProductCard = ({ product }) => {
	...
	console.log("voila les produit : ", product);

	return (
		<div className='flex w-full relative flex-col overflow-hidden rounded-lg border border-gray-700 shadow-lg'>
			<div className='relative mx-3 mt-3 flex items-center justify-center h-60 w-auto overflow-hidden rounded-xl bg-white'>
				<img
